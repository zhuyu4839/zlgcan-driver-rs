...
// pub trait ZDevice<Api, DH, CH>
//     where
//         Api: ZCanApi<DH, CH> + ZCloudApi<DH> + ZDeviceApi<DH, CH> + ZLinApi<DH, CH> {
//     fn api(&self) -> &mut Api;
pub trait ZDevice {
...
// pub struct ZCanDriver<API, DH, CH>
//     where
//         for<'a> API: ZDeviceApi<DH, CH> + ZCanApi<DH, CH> + ZLinApi<DH, CH> + ZCloudApi<DH> {
