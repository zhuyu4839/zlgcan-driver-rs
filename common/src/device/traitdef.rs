...
use crate::can::{BitrateCfg, CanChlCfg, CanChlCfgExt};
use crate::can::channel::{ZCanChlError, ZCanChlStatus};
use crate::can::constant::{ZCanChlMode, ZCanChlType, ZCanFrameType};
...
pub trait ZCanDevice {
    fn new_can_chl_cfg(&self, dev_type: ZCanDeviceType, can_type: ZCanChlType, mode: ZCanChlMode, bitrate: u32, extra: CanChlCfgExt) -> CanChlCfg {
        CanChlCfg::new(
            dev_type, can_type, mode, bitrate, extra, self.can_bitrate_cfg()
        )
    }
